...
function classiera_scripts_styles(){
	...
	wp_enqueue_script('jasny-bootstrap.min', get_template_directory_uri() . '/js/jasny-bootstrap.min.js', 'jquery', '', true);
    ...
    // Load google maps js
	wp_enqueue_script('gmap3.min', get_template_directory_uri() . '/js/gmap3.min.js', 'jquery', '', true);
	
    // Load google maps js
	wp_enqueue_script('gmap3.infobox', get_template_directory_uri() . '/js/gmap3.infobox.js', 'jquery', '', true);	
	...
	wp_enqueue_style( 'jasny-bootstrap.min', get_template_directory_uri() . '/css/jasny-bootstrap.min.css', array(), '1' );
