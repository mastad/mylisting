<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
			...
			array(
				...
				'type' => 'text',
				'title' => __('Categoreis Count on All Categoreis Page', 'classiera'),
				'subtitle' => __('Put Number', 'classiera'),
				'desc' => __('How Many Categoreis you want to shown on All Categoreis Page', 'classiera'),
				'default' => '12'
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		array(
			...
			'type' => 'media', 
			'url'=> true,
			'title' => __('CTA Bakground', 'classiera'),
			'compiler' => 'true',
			//'mode' => false, // Can be set to false to allow any media type, or can also be set to any mime type.
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'textarea',
				'title' => __('Blog Section Decciption', 'classiera'),
				'subtitle' => __('Replace text', 'classiera'),
				'desc' => __('Change blog section Decciption from homepage.', 'classiera'),
    ...
    Redux::setSection( $opt_name, array(
		...
		'fields'     => array(			
			...
			array(
				...
				'options' => array('1' => 'Version 1(Lime)', '2' => 'Version 2(Strobe)', '3' => 'Version 3(Coral)', '4' => 'Version 4(Canary)', '5' => 'Version 5(IVY)', '6' => 'Version 6(IRIS-Allure)'),//Must provide key => value pairs for radio options
				'default' => '1'
			),
			array(
				'id'=>'classiera_cat_style',
				'type' => 'radio',
				'title' => __('Categoreis Styles', 'classiera'), 
				'subtitle' => __('Select Styles', 'classiera'),
				'desc' => __('Selection Will work on all pages other then homepage, on homepage Design will be used from template', 'classiera'),
				'options' => array('1' => 'Version 1(Lime)', '2' => 'Version 2(Strobe)', '3' => 'Version 3(Coral)', '4' => 'Version 4(Canary)', '5' => 'Version 5(IVY)', '6' => 'Version 6(IRIS)', '7' => 'Version 7(Allure)'),//Must provide key => value pairs for radio options
				'default' => '1'
			...
			array(
				...
				'desc' => __('You want to show categories icons from font awsome or you have your own images icon?', 'classiera'),
			...
			array(
                ...
                'options'  => array(
                    'disabled' => array( 
						...
						'imgslider1' => 'Image Slider Style 1',
						'imgslider2' => 'Image Slider Style 2',
						'imgslider3' => 'Image Slider Style 3',
						'searchv2' => 'Search Style 2',
						'searchv3' => 'Search Style 3',
						'searchv4' => 'Search Style 4',
						'searchv5' => 'Search Style 5',
						'searchv6' => 'Search Style 6',
						'searchv7' => 'Search Style 7',
						'premiumslider2'   => 'Premium Ads Style 2',
						'premiumslider3'   => 'Premium Ads Style 3',
						'premiumslider4'   => 'Premium Ads Style 4',
						'premiumslider5'   => 'Premium Ads Style 5',
						'premiumslider6'   => 'Premium Ads Style 6',
						'categories2'   => 'Categories Style 2',
						'categories3'   => 'Categories Style 3',
						'categories4'   => 'Categories Style 4',
						'categories5'   => 'Categories Style 5',
						'categories6'   => 'Categories Style 6',
						'categories7'   => 'Categories Style 7',
						'advertisement2'   => 'Advertisement Style 2',		
						'advertisement3'   => 'Advertisement Style 3',		
						'advertisement4'   => 'Advertisement Style 4',		
						'advertisement5'   => 'Advertisement Style 5',		
						'advertisement6'   => 'Advertisement Style 6',		
						'advertisement7'   => 'Advertisement Style 7',
						'locationv2'   => 'Location Style 2',
						'locationv3'   => 'Location Style 3',
						'locationv4'   => 'Location Style 4',
						'locationv5'   => 'Location Style 5',
						'plans2'   => 'Pricing Plans Style 2',
						'plans3'   => 'Pricing Plans Style 3',
						'plans4'   => 'Pricing Plans Style 4',
						'plans5'   => 'Pricing Plans Style 5',
						'plans6'   => 'Pricing Plans Style 6',
						'plans7'   => 'Pricing Plans Style 7',
						'callout2'   => 'Callout Style 2',
						'callout3'   => 'Callout Style 3',
						'callout4'   => 'Callout Style 4',
						'callout5'   => 'Callout Style 5',
						'callout6'   => 'Callout Style 6',
						'callout7'   => 'Callout Style 7',
						'callout7'   => 'Callout Style 7',
                    ...
                    'enabled'  => array(
                        'layerslider' => 'LayerSlider',
						'searchv1' => 'Search Style 1',
						'premiumslider1'   => 'Premium Ads Style 1',
						'categories1'   => 'Categories Style 1',
						'advertisement1'   => 'Advertisement Style 1',
						'locationv1'   => 'Location Style 1',
						'plans1'   => 'Pricing Plans Style 1',
						'callout1'   => 'Callout Style 1',
						'partners1'   => 'Partners Style 1',
						'blogs1'   => 'Blog Style 1',
                    ),
                ),
            ),
    ...
    Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				...
				'options' => array('7' => 'One week', '30' => 'One Month', '60' => 'Two Months', '90' => 'Three Months', '120' => 'Four Months', '150' => 'Five Months', '180' => 'Six Month', '365' => 'One Year', '365000' => 'Life Time'),//Must provide key => value pairs for radio options
				'default' => '365000'
			),
			array(
		...
		'fields'     => array(
		   ...
		   array(
			...
			array(
				...
				'desc' => __('If you want remove Ad Locations section completly then Turn Off this option, It will remove Country, States,City, Address, Google Latitude, Google Longitude and Google MAP Option.', 'classiera'),
				'default' => 1,
            ),
			array(
			...
			array(
				...
				'type' => 'button_set',
				'title' => __('Select Currecny', 'classiera'),
				'subtitle' => __('Ads Posts', 'classiera'),
				'options' => array('multi' => 'Multi Currecny', 'single' => 'Single Currecny'),
				'desc' => __('If you want to run your website only in one country then just select Single Currency. If you will select Multi Currecny then On Submit Ad Page there will be a dropdown from where user can select currecny tag.', 'classiera'),
				'default' =>'multi',
			),
			array(
			...
			array(
				...
				'title' => __('Currency Tag', 'classiera'),
				'subtitle' => __('Currency Tag', 'classiera'),
				'desc' => __('Put Your Own Currecny Symbol or HTML code to display', 'classiera'),
				'default' => '$',
    ...
    Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Profile Settings Page URL', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Submit Ad Page URL', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
			array(
			...
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Pricing Plans Page URL', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
			array(
			...
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Single User Account Page All Plans URL', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
			array(
			...
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Single User Account Page All Follower URL', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
			array(
			...
			array(
				...
				'subtitle' => __('This must be an URL.', 'classiera'),
				'desc' => __('Please Put Woo Commerece URL here', 'classiera'),
				'validate' => 'url',
				'default' => ''
			),
		)
