					...
					<?php if($_POST){?>
						...
						if($registerSuccess == 1){
							...
							<div class="alert alert-success" role="alert">
							  <strong><?php esc_html_e('Well done!', 'classiera') ?></strong> <?php esc_html_e('You successfully registred', 'classiera') ?> <a href="<?php echo $login; ?>" class="alert-link"><?php esc_html_e('Click here', 'classiera') ?></a> <?php esc_html_e('for login', 'classiera') ?>.
							</div>
							<?php
						}else{
							?>
						...
						<div class="col-lg-8 col-sm-11 col-md-9 center-block">
							<form data-toggle="validator" role="form" id="myform" action="" method="POST" enctype="multipart/form-data">
								...
								<div class="col-lg-9 col-sm-9 pull-right flip">
                                    ...
                                    <div class="form-group">
                                        <p><?php esc_html_e('Already have account?', 'classiera') ?> <a href="<?php echo $login; ?>"><?php esc_html_e('Login here', 'classiera') ?></a></p>
                                    </div>
                                </div>
								<!--terms-->
							</form>
