				...
				<div class="owl-carousel partner-carousel-v3" data-car-length="6" data-items="6" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="2000" data-dots="true" data-auto-width="false" data-auto-height="true" data-right="false" data-responsive-small="2" data-autoplay-hover="true" data-responsive-medium="4" data-responsive-xlarge="6" data-margin="30">
					<?php if(!empty($partner1)){?>
						<div class="item partner-img match-height">
							...
							<a href="<?php echo $partner1URL; ?>"><img src="<?php echo $partner1; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner2)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner2URL; ?>"><img src="<?php echo $partner2; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner3)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner3URL; ?>"><img src="<?php echo $partner3; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner4)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner4URL; ?>"><img src="<?php echo $partner4; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner5)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner5URL; ?>"><img src="<?php echo $partner5; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner6)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner6URL; ?>"><img src="<?php echo $partner6; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner7)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner7URL; ?>"><img src="<?php echo $partner7; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
					<?php if(!empty($partner8)){?>
						<div class="item partner-img match-height">
							<span class="helper"></span>
							<a href="<?php echo $partner8URL; ?>"><img src="<?php echo $partner8; ?>" alt="<?php esc_html_e('partner', 'classiera') ?>"></a>
						</div>
					<?php } ?>
				</div>
			</div><!--col-lg-12-->	
