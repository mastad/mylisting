					...
					<div class="pricing-plan-box border <?php if($popular_plan == 'true'){echo "popular";} ?>">
						...
						<form method="post" class="planForm">
							...
							<a class="btn btn-primary round btn-md btn-style-two" href="<?php echo $link; ?>">
								...
								?>
							<a rel="nofollow" href="#" data-quantity="1" data-product_id="<?php echo $wooID; ?>" data-product_sku="" class="btn btn-primary round btn-md btn-style-two button product_type_simple add_to_cart_button ajax_add_to_cart">
							<span><i class="fa fa-plus"></i></span>
