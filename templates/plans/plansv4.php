					...
					<div class="pricing-plan-box <?php if($popular_plan == 'true'){echo "popular";} ?>">
						...
						<form method="post" class="planForm">
							...
							<a class="btn btn-primary btn-md btn-style-four" href="<?php echo $link; ?>">
								...
								?>
							<a rel="nofollow" href="#" data-quantity="1" data-product_id="<?php echo $wooID; ?>" data-product_sku="" class="btn btn-primary btn-md btn-style-four product_type_simple add_to_cart_button ajax_add_to_cart">
