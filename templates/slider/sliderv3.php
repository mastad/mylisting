						...
						<div class="form-v6-bg">
							...
							<div class="form-group">
								<div class="input-group inner-addon left-addon">
									...
									<input type="text" id="getCity" name="post_location" class="form-control form-control-lg" placeholder="<?php esc_html_e('Please add an address or Zipcode', 'classiera'); ?>">
