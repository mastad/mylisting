				...
				<form data-toggle="validator" role="form" class="search-form search-form-v1 form-inline" action="<?php echo home_url(); ?>" method="get">
					...
					<div class="form-group">
                        <div class="inner-addon right-addon">
                            ...
                            <input type="text" id="getCity" name="post_location" class="form-control form-control-sm sharp-edge" placeholder="<?php esc_html_e('Please type your location', 'classiera'); ?>">
                        </div>
                    </div>
					<?php } ?>
					<!--Locations-->
