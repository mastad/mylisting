				...
				if(trim($_POST['edit-feature-plan']) != ''){
					...
					if ( $result ) {
						...
						foreach ( $result as $info ){
							...
							if($usedAds < $totalAds && $availableADS != "0"){
								global $wpdb;
								$newUsed = $info->used +1;
				...
				<div class="submit-post submit-post-v2 section-bg-white">
					<form class="form-horizontal" action="" role="form" id="primaryPostForm" method="POST" data-toggle="validator" enctype="multipart/form-data">
						...
						<div class="form-main-section post-detail">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php esc_html_e('Keywords', 'classiera') ?> : <span>*</span></label>
                                <div class="col-sm-8">
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php esc_html_e('Your Phone/Mobile', 'classiera') ?> : <span>*</span></label>
                                <div class="col-sm-8">
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php esc_html_e('Ad price', 'classiera') ?> : <span>*</span></label>
                                <div class="col-sm-8">
                                    <div class="form-inline row">										
						...
						<div class="form-main-section post-type">
							...
							<?php 
								...
								if(!empty($result)){
									foreach ( $result as $info ) {
										...
										if($availableADS != 0){
										?>
											<div class="col-md-offset-3 col-sm-4 col-md-2 col-lg-2">
												<div class="post-type-box">
							...
							<?php if($regular_ads == 1 ){?>
                                <div class="col-sm-4 col-md-2 col-lg-2 active-post-type">
                                    <div class="post-type-box">
                                        ...
                                        <div class="radio">
                                            <input id="regular" type="radio" name="edit-feature-plan" checked>
