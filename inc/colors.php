...
function classiera_wpcss_head() {
	...
	if(!empty($classieraSecondaryColor)){
		...
		echo ".btn-primary.btn-style-six:hover, .btn-primary.btn-style-six.active, .pricing-plan-v6.pricing-plan-v7 .pricing-plan-box.popular, .pricing-plan-v6 .pricing-plan-content .pricing-plan-box.popular .pricing-plan-button .btn.round:hover, .classiera-navbar.classiera-navbar-v3 ul.navbar-nav li.dropdown ul.dropdown-menu > li.active > a{background: ";
		echo $classieraSecondaryColor;
		echo " !important; } ";
	...
	section.classiera-static-slider .classiera-static-slider-content h1, section.classiera-static-slider-v2 .classiera-static-slider-content h1, section.classiera-simple-bg-slider .classiera-simple-bg-slider-content h1{
		...
		font-family:<?php echo $redux_demo['classiera_banner_heading_typography']['font-family']; ?>;
	...
	section.classiera-static-slider .classiera-static-slider-content h2, section.classiera-static-slider-v2 .classiera-static-slider-content h2, section.classiera-simple-bg-slider .classiera-simple-bg-slider-content h4{
		...
		font-family:<?php echo $redux_demo['classiera_banner_desc_typography']['font-family']; ?>;
